...
% Loading of the basic model generated by RAVEN
load('/Users/emilljungqvist/Documents/Geobacillus/MATLAB/LC300/Models/LC300KEGGModel(nospont).mat')
% Settings: Remove spontaneous, undefined, inclomplete and general. CutOff=10^-50. 
...
load('/Users/emilljungqvist/Documents/Geobacillus/MATLAB/LC300/Models/gelbasemodel.mat');


model=keggmodel3;

model.comps{1,1}='c';
model.compNames{1,1}='Cytosol';
model.comps{2,1}='e';
model.compNames{2,1}='Extracellular';
...
flux2csv(model1, sol.x, 'Escher/lc300fluxxyl.txt')
